...
const products = [
  {
    id: 1,
    name: "Analizador de Tiras de Orina - NUVE",
    category: "Equipos de Laboratorio",
    image: "/img-categories/analizador1.png",
    link: "/productos/1",
    hoverImage: "/img-categories/analizador2.png",
  },
  {
    id: 2,
    name: "3M Clinpro",
    category: "Cuidado Bucal",
    image: "/img-categories/clinpro1.png",
    link: "/productos/2",
    hoverImage: "/img-categories/clinpro2.png",
  },
  {
    id: 3,
    name: "Ecotest - Prueba Rápida HCG",
    category: "Pruebas Rápidas y Reactivos",
    image: "/img-categories/hcg1.png",
    link: "/productos/3",
    hoverImage: "/img-categories/hcg2.png",
  },
  {
    id: 4,
  ...
  {
    id: 5,
    name: "Dermosol - Protectores Solares",
    category: "Cuidado Personal y Hogar",
    image: "/img-categories/dermosol1.png",
    link: "/productos/5",
    hoverImage: "/img-categories/dermosol2.png",
  },
  {
    id: 6,
  ...
  return (
    <div className="bg-six py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold dark:text-gray-800 mb-8">
        ...
        <div className="flex flex-col md:grid gap-4 h-auto md:h-[600px] md:grid-cols-4 md:grid-rows-3 md:gap-6">
          {products.map((product, index) => {
            ...
            const textSize =
              index === 4 ? "md:text-3xl" : index === 1 ? "md:text-2xl" : "";
            ...
            return (
              <a
                ...
                key={index}
                className={`relative overflow-hidden rounded-lg shadow-lg hover:scale-105 hover:shadow-lg hover:translate-y-[-10px] transition-transform duration-300 ease-in-out md:shadow-slate-400 ${
                  index === 4
                ...
                <div className="absolute inset-0 w-full h-full  opacity-0 hover:opacity-100 transition-opacity duration-300 ease-in-out">
                  ...
                  <div className="absolute bottom-0 left-0 p-4 z-20">
                    ...
                    {/* Texto */}
                    <h3
                      className={`relative text-white ${textSize} font-semibold text-shadow`}>
                      {product.name}
                    </h3>
